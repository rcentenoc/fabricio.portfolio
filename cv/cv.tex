...
\TopLeftQR[2.3cm]{https://fabriciocc.vercel.app/} % o tu URL personal
    \begin{header}
        ...
        \AND%
        \kern 5.0 pt%
        \mbox{\hrefWithoutArrow{https://www.linkedin.com/in/r-fabricio}\faLinkedinIn\;\hrefWithoutArrow{https://www.linkedin.com/in/r-fabricio}{linkedin.com/in/r-fabricio}}%
        \kern 5.0 pt%
        \AND%
        \kern 5.0 pt%
